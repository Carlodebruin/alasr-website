        ...
        <section className="bg-primary py-10 lg:py-14">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="mt-10 flex justify-center gap-4">
                    <Button variant="secondary" size="lg" href="/admissions" className="px-6 py-3 md:px-8 md:py-4 text-base md:text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all">
                        Start Application
